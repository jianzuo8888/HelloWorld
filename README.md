...
//
//  /*PM10 data by UART1*/
//  float SendPM10Data=0;
 volatile uint8_t SVR_LOGIN[52]={0x50,0x2D,0x33,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,		    /*设备型号(11位)：P-3          */
					    0x44,0x55,0x53,0x54,0x00,0x00,0x00,0x00,0x00,					/*设备名称( 9位)：DUST         */
						/*5#设备（关中酒厂）：15213499368，1023-0005-*/
//					    0x31,0x35,0x32,0x31,0x33,0x34,0x39,0x39,0x33,0x36,0x38,0x00,	/*SIM卡号 (12位)：15213499368  */
//					    0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x00,					/*登录密码( 9位)：88888888     */
//					    0x31,0x30,0x32,0x33,0x2D,0x30,0x30,0x30,0x35,0x2D,0x00		    /*设备ID号(11位)：1023-0005-   */
						/*4#设备（大寨社区）：15213499284，1023-0004-*/
//					    0x31,0x35,0x32,0x31,0x33,0x34,0x39,0x39,0x32,0x38,0x34,0x00,	/*SIM卡号 (12位)：15213499284  */
//					    0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x00,					/*登录密码( 9位)：88888888     */
//					    0x31,0x30,0x32,0x33,0x2D,0x30,0x30,0x30,0x34,0x2D,0x00		    /*设备ID号(11位)：1023-0004-   */
						/*3#设备（步长制药）：15213499068，1023-0003-*/
//					    0x31,0x35,0x32,0x31,0x33,0x34,0x39,0x39,0x30,0x36,0x38,0x00,	/*SIM卡号 (12位)：15213499068  */
//					    0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x00,					/*登录密码( 9位)：88888888     */
//					    0x31,0x30,0x32,0x33,0x2D,0x30,0x30,0x30,0x33,0x2D,0x00		    /*设备ID号(11位)：1023-0003-   */
						/*7#设备（单位七楼）：18202341470，1023-0007-*/
					    0x31,0x38,0x32,0x30,0x32,0x33,0x34,0x31,0x34,0x37,0x30,0x00,	/*SIM卡号 (12位)：18202341470  */
					    0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x00,					/*登录密码( 9位)：88888888     */
					    0x31,0x30,0x32,0x33,0x2D,0x30,0x30,0x30,0x37,0x2D,0x00		    /*设备ID号(11位)：1023-0007-   */
					   };
  volatile uint32_t SVR_LOGIN_Regist[5]={0};
  volatile uint8_t  SVR_LOGIN_EEPROM[9]={0};

  volatile float All_Results_Float_Buffer[13]={0.0}; 	 /*	左健02.11：增加此数组用于存放所有浮点类型测试结果，位置对应如下：
												    0		 1			 2			3			   4			5
								             	 噪声(dBA)，TSP(ug/m3)，风速(m/s)，风向(°顺时针)，温度(°C)，   湿度(%RH)，
								 					6		 7			 8			9			   10		    11
								 				 气压(Kpa)，雨量(mm)，  电流(mA)， 电压(V),     PM10(ug/m3)，PM2.5(ug/m3)	*/								

										
  /*重新读取本底值标志位*/
  volatile uint8_t GetBackGFlag=0;
